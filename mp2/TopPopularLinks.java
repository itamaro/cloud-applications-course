...
// <<< Don't Change
    ...
    public static class TopLinksMap extends Mapper<Text, Text, NullWritable, IntArrayWritable> {
        Integer N;
        private TreeSet<Pair<Integer, Integer>> linkCountToPageIdMap = new TreeSet<Pair<Integer, Integer>>();
        ...
        public void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            ...
            linkCountToPageIdMap.add(new Pair<Integer, Integer>(numLinks, pageId));
            if (linkCountToPageIdMap.size() > this.N) {
                linkCountToPageIdMap.remove(linkCountToPageIdMap.first());
            }
        }

        @Override
        protected void cleanup(Context context) throws IOException, InterruptedException {
            for (Pair<Integer, Integer> item : linkCountToPageIdMap) {
                Integer[] page_ids = {item.second, item.first};
                context.write(NullWritable.get(), new IntArrayWritable(page_ids));
            }
        }
    }
